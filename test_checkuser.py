...
class test_checkuser(unittest.TestCase):
    ...
    def testValidUser(self): 
        self.assertEqual(getInfo("evanciok"), ['567_GitHubAPI has 7 commits', 'cs555tm012023fall has 11 commits', 'Singleton-Visitor has 3 commits', 'SSW-567 has 3 commits', 'SSW567HW02 has 12 commits'])
